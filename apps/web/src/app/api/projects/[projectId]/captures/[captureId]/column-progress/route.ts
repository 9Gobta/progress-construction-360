...
export async function PUT(
  ...
  try {
    const result = await apiRequest(`/projects/${projectId}/captures/${captureId}/column-progress`, {
      method: "PUT",
      token,
    ...
    return NextResponse.json({
      detail: error instanceof Error ? error.message : "บันทึก Progress เสาไม่สำเร็จ",
    }, { status });
  }
}
